...
if (isset($_POST['donner_avis'])) {
    ...
    try {
        $sql = 'INSERT INTO trajet (commentaire_avis, note_avis) VALUES (:commentaireAvis, :noteAvis)';
        ...
        echo '<script>alert("L\'avis à bien été pris en compte !. \nMon avis : ' . $commentaireAvis . ' \nMon avis : ' . $noteAvis . '");</script>';

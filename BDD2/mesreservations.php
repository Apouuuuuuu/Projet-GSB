    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link" href="http://localhost/gsb/BDD2/mesreservations.php"><strong>Mes réservations</strong></a>
    ...
    foreach ($reservations as $liste_reservation) { 
        ...
        <form action="" method="POST">
            <tr>
                ...
                <input type="hidden" name="id_reservation" value="<?= $liste_reservation["id_reservation"] ?>">
            </tr>
        </form>
    <?php
    }
